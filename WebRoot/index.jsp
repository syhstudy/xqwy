        ...
        <tr> 
          <td height="370" align="center" valign="top" style="font-size:15px">
			...
			<%
				...
				ResultSet rs3=db.executeQuery("select * from xqgg order by rec_id desc");
				int ggid=0;
				while (rs3.next())
				{
				...
				<table width='100%' cellSpacing=0 cellPadding=0 border=0  style='line-height:130% '>
					<tr>
						...
						<td width='80' style='border-bottom: 1px dotted #cccccc'><%=addtime.substring(0,10)%></td>
